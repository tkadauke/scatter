...
class Scatter::SuperCommandTest < Test::Unit::TestCase
  ...
  class Testcmd::Sub < Scatter::SubCommand
    def initialize(out, a, b)
      super(out)
    end
    def execute!
    end
